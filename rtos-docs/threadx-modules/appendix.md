...
#### <a name="module-linker-for-cortex-m33-using-ac6"></a>AC6 kullanarak Cortex için modül Bağlayıcısı-M33

KEIL araç zinciri için bağlayıcı dosyası gerekmez. Örnek projede derleme ayarları ' na bakın.
Önemli bağlayıcı seçenekleri aşağıda listelenmiştir:

```c
--entry demo_module_start --first __txm_module_preamble
```

#### <a name="building-modules-for-cortex-m33-using-ac6"></a>AC6 kullanarak Cortex için modüller oluşturma-M33
...
#### <a name="thread-extension-definition-for-cortex-m33-using-ac6"></a>AC6 kullanarak Cortex için iş parçacığı uzantısı tanımı M33
...
#### <a name="building-module-manager-for-cortex-m33-using-ac6"></a>AC6 kullanarak Cortex için Modül Yöneticisi oluşturma-M33

Örnek çalışma alanı sağlanır. ThreadX kitaplığı, ThreadX modülleri kitaplığı, sample_threadx_module projesi ve demo_threadx_non secure_zone projesi oluşturun.

#### <a name="attributes-for-external-memory-enable-api-for-cortex-m33-using-ac6"></a>Dış bellek öznitelikleri M33 Cortex için API 'YI etkinleştirir-AC6 kullanarak

| Öznitelik parametresi |
|---|
...
### <a name="cortex-m33-using-gnu"></a>Cortex-GNU kullanarak M33

#### <a name="module-preamble-for-cortex-m33-using-gnu"></a>GNU kullanarak Cortex için modül girişi-M33

#### <a name="module-properties-for-cortex-m33-using-gnu"></a>GNU kullanarak Cortex-M33 için modül özellikleri
...
#### <a name="module-linker-for-cortex-m33-using-gnu"></a>GNU kullanarak Cortex için modül Bağlayıcısı-M33

#### <a name="building-modules-for-cortex-m33-using-gnu"></a>GNU kullanarak Cortex için modüller oluşturma-M33

#### <a name="thread-extension-definition-for-cortex-m33-using-gnu"></a>GNU kullanarak Cortex-M33 için iş parçacığı uzantısı tanımı

#### <a name="building-module-manager-for-cortex-m33-using-gnu"></a>GNU kullanarak Cortex için Modül Yöneticisi oluşturma-M33

#### <a name="attributes-for-external-memory-enable-api-for-cortex-m33-using-gnu"></a>Dış bellek öznitelikleri, GNU kullanarak Cortex için API 'YI etkinleştirir-M33
...
### <a name="cortex-m33-using-iar"></a>Cortex-ıAR kullanarak M33

#### <a name="module-preamble-for-cortex-m33-using-iar"></a>IAR kullanarak Cortex için modül girişi-M33
...
#### <a name="module-properties-for-cortex-m33-using-iar"></a>IAR kullanarak Cortex-M33 için modül özellikleri
...
#### <a name="module-linker-for-cortex-m33-using-iar"></a>IAR kullanarak Cortex için modül Bağlayıcısı-M33
...
#### <a name="building-modules-for-cortex-m33-using-iar"></a>IAR kullanarak Cortex için modüller oluşturma-M33

#### <a name="thread-extension-definition-for-cortex-m33-using-iar"></a>IAR kullanarak Cortex-M33 için iş parçacığı uzantısı tanımı
...
#### <a name="building-module-manager-for-cortex-m33-using-iar"></a>IAR kullanarak Cortex için Modül Yöneticisi oluşturma-M33

Örnek çalışma alanı henüz sağlanmadı. Çok yakında.

#### <a name="attributes-for-external-memory-enable-api-for-cortex-m33-using-iar"></a>Dış bellek öznitelikleri ıAR kullanarak Cortex için API 'YI etkinleştirir-M33
...
## <a name="cortex-m4-processor"></a>Cortex-M4 işlemcisi

### <a name="cortex-m4-using-ac5"></a>Cortex-AC5 kullanarak M4

#### <a name="module-preamble-for-cortex-m4-using-ac5"></a>AC5 kullanarak Cortex için modül girişi-M4
...
#### <a name="module-properties-for-cortex-m4-using-ac5"></a>AC5 kullanarak Cortex-M4 için modül özellikleri
...
#### <a name="module-linker-for-cortex-m4-using-ac5"></a>AC5 kullanarak Cortex için modül Bağlayıcısı-M4

Örnek bağlayıcı dosyası sağlanmaz; bağlantı, komut satırında yapılır. Sonraki bölüme bakın.

#### <a name="building-modules-for-cortex-m4-using-ac5"></a>AC5 kullanarak Cortex için modüller oluşturma-M4

Bkz. örnek build_threadx_module_demo.bat:
...
#### <a name="thread-extension-definition-for-cortex-m4-using-ac5"></a>AC5 kullanarak Cortex için iş parçacığı uzantısı tanımı M4
...
#### <a name="building-module-manager-for-cortex-m4-using-ac5"></a>AC5 kullanarak Cortex için Modül Yöneticisi oluşturma-M4
...
### <a name="cortex-m4-using-ac6"></a>Cortex-AC6 kullanarak M4

#### <a name="module-preamble-for-cortex-m4-using-ac6"></a>AC6 kullanarak Cortex için modül girişi-M4
...
#### <a name="module-properties-for-cortex-m4-using-ac6"></a>AC6 kullanarak Cortex-M4 için modül özellikleri
...
#### <a name="module-linker-for-cortex-m4-using-ac6"></a>AC6 kullanarak Cortex için modül Bağlayıcısı-M4

Bağlayıcı dosyası kullanılmaz. Bkz. proje ayarları.

#### <a name="building-modules-for-cortex-m4-using-ac6"></a>AC6 kullanarak Cortex için modüller oluşturma-M4
...
#### <a name="thread-extension-definition-for-cortex-m4-using-ac6"></a>AC6 kullanarak Cortex için iş parçacığı uzantısı tanımı M4
...
#### <a name="building-module-manager-for-cortex-m4-using-ac6"></a>AC6 kullanarak Cortex için Modül Yöneticisi oluşturma-M4
...
### <a name="cortex-m4-using-gnu"></a>Cortex-GNU kullanarak M4

#### <a name="module-preamble-for-cortex-m4-using-gnu"></a>GNU kullanarak Cortex için modül girişi-M4
...
#### <a name="module-properties-for-cortex-m4-using-gnu"></a>GNU kullanarak Cortex-M4 için modül özellikleri
...
#### <a name="module-linker-for-cortex-m4-using-gnu"></a>GNU kullanarak Cortex için modül Bağlayıcısı-M4
...
#### <a name="building-modules-for-cortex-m4-using-gnu"></a>GNU kullanarak Cortex için modüller oluşturma-M4
...
#### <a name="thread-extension-definition-for-cortex-m4-using-gnu"></a>GNU kullanarak Cortex-M4 için iş parçacığı uzantısı tanımı
...
#### <a name="building-module-manager-for-cortex-m4-using-gnu"></a>GNU kullanarak Cortex için Modül Yöneticisi oluşturma-M4
...
### <a name="cortex-m4-using-iar"></a>Cortex-ıAR kullanarak M4

#### <a name="module-preamble-for-cortex-m4-using-iar"></a>IAR kullanarak Cortex için modül girişi-M4
...
#### <a name="module-properties-for-cortex-m4-using-iar"></a>IAR kullanarak Cortex-M4 için modül özellikleri
...
#### <a name="module-linker-for-cortex-m4-using-iar"></a>IAR kullanarak Cortex için modül Bağlayıcısı-M4
...
#### <a name="building-modules-for-cortex-m4-using-iar"></a>IAR kullanarak Cortex için modüller oluşturma-M4
...
#### <a name="thread-extension-definition-for-cortex-m4-using-iar"></a>IAR kullanarak Cortex-M4 için iş parçacığı uzantısı tanımı
...
#### <a name="thread-extension-definition-for-cortex-m7-using-gnu"></a>GNU kullanarak Cortex-M7 için iş parçacığı uzantısı tanımı
...
#### <a name="module-linker-for-cortex-r4-using-ac6"></a>AC6 kullanarak Cortex için modül Bağlayıcısı-R4

Komut satırı üzerine inşa, bağlayıcı dosyası örneği yok.

#### <a name="building-modules-for-cortex-r4-using-ac6"></a>AC6 kullanarak Cortex için modüller oluşturma-R4

AC6 kullanarak Cortex-R4 modülü oluşturmaya yönelik basit bir komut satırı örneği:
...
#### <a name="thread-extension-definition-for-cortex-r4-using-ac6"></a>AC6 kullanarak Cortex için iş parçacığı uzantısı tanımı R4
...
#### <a name="building-module-manager-for-cortex-r4-using-ac6"></a>AC6 kullanarak Cortex için Modül Yöneticisi oluşturma-R4

AC6 kullanarak Cortex-R4 Module Manager oluşturmaya yönelik basit bir komut satırı örneği:
...
### <a name="cortex-r4-using-iar"></a>Cortex-ıAR kullanarak R4

#### <a name="module-preamble-for-cortex-r4-using-iar"></a>IAR kullanarak Cortex için modül girişi-R4
...
#### <a name="module-properties-for-cortex-r4-using-iar"></a>IAR kullanarak Cortex-R4 için modül özellikleri
...
#### <a name="module-linker-for-cortex-r4-using-iar"></a>IAR kullanarak Cortex için modül Bağlayıcısı-R4
...
#### <a name="building-modules-for-cortex-r4-using-iar"></a>IAR kullanarak Cortex için modüller oluşturma-R4

Örnek çalışma alanı sağlanır. ThreadX kitaplığı, ThreadX modülleri kitaplığı, demo modülü projesi ve tanıtım modülü Yöneticisi projesi oluşturun.

#### <a name="thread-extension-definition-for-cortex-r4-using-iar"></a>IAR kullanarak Cortex-R4 için iş parçacığı uzantısı tanımı
...
#### <a name="building-module-manager-for-cortex-r4-using-iar"></a>IAR kullanarak Cortex için Modül Yöneticisi oluşturma-R4
...
## <a name="mcf544xx-processor"></a>MCF544xx işlemcisi

### <a name="mcf544xx-using-ghs"></a>GHS kullanarak MCF544xx

#### <a name="module-preamble-for-mcf544xx-using-ghs"></a>GHS kullanarak MCF544xx için modül girişi
...
#### <a name="module-properties-for-mcf544xx-using-ghs"></a>GHS kullanarak MCF544xx için modül özellikleri

| Sürümleri | Değer | Anlamı |
|---|---|---|
| 0 | 0<br />1 | Ayrıcalıklı mod yürütme<br />Kullanıcı modu yürütme |
| 1 | 0<br />1 | MMU koruması yok<br />MMU koruması (Kullanıcı modunun seçili olması gerekir) |
| 2 | 0<br />1 | Paylaşılan/dış bellek erişimini devre dışı bırak<br />Paylaşılan/dış bellek erişimini etkinleştir |
| [23-3] | 0 | Ayrılmıştır
| [31-24] | <br />0x03 | **Derleyici KIMLIĞI**<br />GHS |

#### <a name="module-linker-for-mcf544xx-using-ghs"></a>GHS kullanarak MCF544xx için modül Bağlayıcısı
...
#### <a name="building-modules-for-mcf544xx-using-ghs"></a>GHS kullanarak MCF544xx için modüller oluşturma

Örnek çalışma alanı sağlanır. ThreadX kitaplığı, ThreadX modülleri kitaplığı, demo modülü projesi ve tanıtım modülü Yöneticisi projesi oluşturun.

#### <a name="thread-extension-definition-for-mcf544xx-using-ghs"></a>GHS kullanarak MCF544xx için iş parçacığı uzantısı tanımı
...
#### <a name="building-module-manager-for-mcf544xx-using-ghs"></a>GHS kullanarak MCF544xx için Modül Yöneticisi derleniyor

Örnek çalışma alanı sağlanır. ThreadX kitaplığı, ThreadX modülleri kitaplığı, demo modülü projesi ve tanıtım modülü Yöneticisi projesi oluşturun.

#### <a name="attributes-for-external-memory-enable-api-for-mcf544xx-using-ghs"></a>Dış bellek öznitelikleri, GHS kullanarak MCF544xx için API 'YI etkinleştirir

Bu özellik MCF544xx üzerinde etkin değil.

## <a name="rx63-processor"></a>RX63 işlemcisi

### <a name="rx63-using-iar"></a>IAR kullanarak RX63

#### <a name="module-preamble-for-rx63-using-iar"></a>IAR kullanarak RX63 için modül girişi
...
## <a name="rx65n-processor"></a>RX65N işlemcisi
