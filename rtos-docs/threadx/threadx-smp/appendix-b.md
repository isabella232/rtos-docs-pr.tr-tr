...
---
# <a name="appendix-b---azure-rtos-threadx-smp-constants"></a><span data-ttu-id="93b2c-103">Ek B-Azure RTOS ThreadX SMP sabitleri</span><span class="sxs-lookup"><span data-stu-id="93b2c-103">Appendix B - Azure RTOS ThreadX SMP Constants</span></span>

## <a name="alphabetic-listings"></a><span data-ttu-id="93b2c-104">Alfabetik listeler</span><span class="sxs-lookup"><span data-stu-id="93b2c-104">Alphabetic Listings</span></span>
...
0xFFFFFFFFUL
```
## <a name="listing-by-value"></a><span data-ttu-id="93b2c-105">Değere göre listeleme</span><span class="sxs-lookup"><span data-stu-id="93b2c-105">Listing by Value</span></span>
