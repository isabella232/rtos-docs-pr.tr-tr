...
---
# <a name="appendix-a---azure-rtos-threadx-smp-api-services"></a><span data-ttu-id="205c3-103">Ek A-Azure RTOS ThreadX SMP API hizmetleri</span><span class="sxs-lookup"><span data-stu-id="205c3-103">Appendix A - Azure RTOS ThreadX SMP API Services</span></span>

## <a name="entry-function"></a><span data-ttu-id="205c3-104">Entry Işlevi</span><span class="sxs-lookup"><span data-stu-id="205c3-104">Entry Function</span></span>

```C
VOID     tx_kernel_enter(VOID);
```
## <a name="block-memory-services"></a><span data-ttu-id="205c3-105">Bellek hizmetlerini engelle</span><span class="sxs-lookup"><span data-stu-id="205c3-105">Block Memory Services</span></span>
...
```
## <a name="byte-memory-services"></a><span data-ttu-id="205c3-106">Bayt bellek Hizmetleri</span><span class="sxs-lookup"><span data-stu-id="205c3-106">Byte Memory Services</span></span>
...
```
## <a name="event-flags-services"></a><span data-ttu-id="205c3-107">Olay bayrakları Hizmetleri</span><span class="sxs-lookup"><span data-stu-id="205c3-107">Event Flags Services</span></span>
...
UINT     tx_event_flags_set_notify(TX_EVENT_FLAGS_GROUP
            ...
            *));
```
## <a name="interrupt-control"></a><span data-ttu-id="205c3-108">Kesme denetimi</span><span class="sxs-lookup"><span data-stu-id="205c3-108">Interrupt Control</span></span>

```C
UINT     tx_interrupt_control(UINT new_posture);
```
## <a name="mutex-services"></a><span data-ttu-id="205c3-109">Mutex Hizmetleri</span><span class="sxs-lookup"><span data-stu-id="205c3-109">Mutex Services</span></span>
...
```
## <a name="queue-services"></a><span data-ttu-id="205c3-110">Kuyruk Hizmetleri</span><span class="sxs-lookup"><span data-stu-id="205c3-110">Queue Services</span></span>
...
```
## <a name="semaphore-services"></a><span data-ttu-id="205c3-111">Semafor Hizmetleri</span><span class="sxs-lookup"><span data-stu-id="205c3-111">Semaphore Services</span></span>
...
UINT     tx_semaphore_put_notify(TX_SEMAPHORE
            ...
            *));
```
## <a name="thread-control-services"></a><span data-ttu-id="205c3-112">İş parçacığı denetim hizmetleri</span><span class="sxs-lookup"><span data-stu-id="205c3-112">Thread Control Services</span></span>
...
```
## <a name="time-services"></a><span data-ttu-id="205c3-113">Zaman hizmetleri</span><span class="sxs-lookup"><span data-stu-id="205c3-113">Time Services</span></span>

```C
ULONG     tx_time_get(VOID);
VOID      tx_time_set(ULONG new_time);
```
## <a name="timer-services"></a><span data-ttu-id="205c3-114">Zamanlayıcı Hizmetleri</span><span class="sxs-lookup"><span data-stu-id="205c3-114">Timer Services</span></span>
