---
title: Ek A-Azure RTOS ThreadX API hizmetleri
description: Azure RTOS ThreadX API hizmetlerini gezin.
author: philmea
ms.author: philmea
ms.date: 05/19/2020
ms.topic: article
...
---
# <a name="appendix-a---azure-rtos-threadx-api-services"></a><span data-ttu-id="a3ea3-103">Ek A-Azure RTOS ThreadX API hizmetleri</span><span class="sxs-lookup"><span data-stu-id="a3ea3-103">Appendix A - Azure RTOS ThreadX API Services</span></span>

## <a name="entry-function"></a><span data-ttu-id="a3ea3-104">Entry Işlevi</span><span class="sxs-lookup"><span data-stu-id="a3ea3-104">Entry Function</span></span>

```c
VOID      tx_kernel_enter(VOID);
```

## <a name="block-memory-services"></a><span data-ttu-id="a3ea3-105">Bellek hizmetlerini engelle</span><span class="sxs-lookup"><span data-stu-id="a3ea3-105">Block Memory Services</span></span>
...
## <a name="byte-memory-services"></a><span data-ttu-id="a3ea3-106">Bayt bellek Hizmetleri</span><span class="sxs-lookup"><span data-stu-id="a3ea3-106">Byte Memory Services</span></span>
...
## <a name="event-flags-services"></a><span data-ttu-id="a3ea3-107">Olay bayrakları Hizmetleri</span><span class="sxs-lookup"><span data-stu-id="a3ea3-107">Event Flags Services</span></span>
...
## <a name="interrupt-control"></a><span data-ttu-id="a3ea3-108">Kesme denetimi</span><span class="sxs-lookup"><span data-stu-id="a3ea3-108">Interrupt Control</span></span>

```c
UINT      tx_interrupt_control(UINT new_posture);
```

## <a name="mutex-services"></a><span data-ttu-id="a3ea3-109">Mutex Hizmetleri</span><span class="sxs-lookup"><span data-stu-id="a3ea3-109">Mutex Services</span></span>
...
```
## <a name="queue-services"></a><span data-ttu-id="a3ea3-110">Kuyruk Hizmetleri</span><span class="sxs-lookup"><span data-stu-id="a3ea3-110">Queue Services</span></span>
...
## <a name="semaphore-services"></a><span data-ttu-id="a3ea3-111">Semafor Hizmetleri</span><span class="sxs-lookup"><span data-stu-id="a3ea3-111">Semaphore Services</span></span>
...
## <a name="thread-control-services"></a><span data-ttu-id="a3ea3-112">İş parçacığı denetim hizmetleri</span><span class="sxs-lookup"><span data-stu-id="a3ea3-112">Thread Control Services</span></span>
...
## <a name="time-services"></a><span data-ttu-id="a3ea3-113">Zaman hizmetleri</span><span class="sxs-lookup"><span data-stu-id="a3ea3-113">Time Services</span></span>
...
## <a name="timer-services"></a><span data-ttu-id="a3ea3-114">Zamanlayıcı Hizmetleri</span><span class="sxs-lookup"><span data-stu-id="a3ea3-114">Timer Services</span></span>
