...
<span data-ttu-id="ff32d-144">DFU cihaz çerçevesi şuna benzeyecektir.</span><span class="sxs-lookup"><span data-stu-id="ff32d-144">A DFU device framework will look like this.</span></span>
...
<span data-ttu-id="ff32d-180">Tipik bir DFU uygulama akışının açıklaması aşağıda verilmiştir.</span><span class="sxs-lookup"><span data-stu-id="ff32d-180">Following is the description of a typical DFU application flow.</span></span>
...
<span data-ttu-id="ff32d-206">USB cihaz PIMA sınıfı, bir USB ana bilgisayar sisteminin (Başlatıcı) bir cihaza bağlanmasını sağlar</span><span class="sxs-lookup"><span data-stu-id="ff32d-206">The USB device PIMA class allows for a USB host system (Initiator) to connect to a</span></span>
...
| <span data-ttu-id="ff32d-265">UX_DEVICE_CLASS_PIMA_EC_OBJECT_ADDED</span><span class="sxs-lookup"><span data-stu-id="ff32d-265">UX_DEVICE_CLASS_PIMA_EC_OBJECT_ADDED</span></span>             | <span data-ttu-id="ff32d-266">0x4002</span><span class="sxs-lookup"><span data-stu-id="ff32d-266">0x4002</span></span>  | <span data-ttu-id="ff32d-267">Cihaz medyasına bir nesne eklenmiştir ve bu, host\tarafından alınabilir.</span><span class="sxs-lookup"><span data-stu-id="ff32d-267">An object has been added to the device media and can be retrieved by the host\.</span></span> |
...
| <span data-ttu-id="ff32d-298">UX_DEVICE_CLASS_PIMA_EC_CAPTURE_COMPLETE</span><span class="sxs-lookup"><span data-stu-id="ff32d-298">UX_DEVICE_CLASS_PIMA_EC_CAPTURE_COMPLETE</span></span>         | <span data-ttu-id="ff32d-299">0x400D</span><span class="sxs-lookup"><span data-stu-id="ff32d-299">0x400D</span></span>  | <span data-ttu-id="ff32d-300">Yakalama tamamlandı</span><span class="sxs-lookup"><span data-stu-id="ff32d-300">Capture is completed</span></span>                                                            |
...
<span data-ttu-id="ff32d-316">PIMA cihaz sınıfı, başlatma sırasında uygulama tarafından sağlanan bazı parametrelere ihtiyaç duyuyor.</span><span class="sxs-lookup"><span data-stu-id="ff32d-316">The PIMA device class needs some parameters supplied by the application during the initialization.</span></span>
...
### <a name="parameters"></a><span data-ttu-id="ff32d-327">Parametreler</span><span class="sxs-lookup"><span data-stu-id="ff32d-327">Parameters</span></span>
...
### <a name="example"></a><span data-ttu-id="ff32d-339">Örnek</span><span class="sxs-lookup"><span data-stu-id="ff32d-339">Example</span></span>
...
### <a name="example"></a><span data-ttu-id="ff32d-351">Örnek</span><span class="sxs-lookup"><span data-stu-id="ff32d-351">Example</span></span>
...
<span data-ttu-id="ff32d-353">Nesne bilgilerini döndürme</span><span class="sxs-lookup"><span data-stu-id="ff32d-353">Return the object information</span></span>
...
### <a name="example"></a><span data-ttu-id="ff32d-373">Örnek</span><span class="sxs-lookup"><span data-stu-id="ff32d-373">Example</span></span>
...
### <a name="description"></a><span data-ttu-id="ff32d-377">Açıklama</span><span class="sxs-lookup"><span data-stu-id="ff32d-377">Description</span></span>
...
## <a name="ux_device_class_pima_object_data_send"></a><span data-ttu-id="ff32d-384">ux_device_class_pima_object_data_send</span><span class="sxs-lookup"><span data-stu-id="ff32d-384">ux_device_class_pima_object_data_send</span></span>

<span data-ttu-id="ff32d-385">Konak nesne verilerini gönderir</span><span class="sxs-lookup"><span data-stu-id="ff32d-385">Host sends the object data</span></span>

### <a name="prototype"></a><span data-ttu-id="ff32d-386">Prototype</span><span class="sxs-lookup"><span data-stu-id="ff32d-386">Prototype</span></span>
...
### <a name="description"></a><span data-ttu-id="ff32d-387">Açıklama</span><span class="sxs-lookup"><span data-stu-id="ff32d-387">Description</span></span>

<span data-ttu-id="ff32d-388">Bu işlev, PIMA sınıfının depolama için yerel sistemdeki nesne verilerini alması gerektiğinde çağrılır.</span><span class="sxs-lookup"><span data-stu-id="ff32d-388">This function is called when the PIMA class needs to receive the object data in the local system for storage.</span></span>

### <a name="parameters"></a><span data-ttu-id="ff32d-389">Parametreler</span><span class="sxs-lookup"><span data-stu-id="ff32d-389">Parameters</span></span>

- <span data-ttu-id="ff32d-390">**Pima**: Pima sınıfı örneğine yönelik işaretçi</span><span class="sxs-lookup"><span data-stu-id="ff32d-390">**pima**: Pointer to the pima class instance</span></span>
- <span data-ttu-id="ff32d-391">**object_handle**: nesnenin tanıtıcısı</span><span class="sxs-lookup"><span data-stu-id="ff32d-391">**object_handle**: Handle of the object</span></span>
- <span data-ttu-id="ff32d-392">**aşama**: aktarımın aşaması (etkin veya tamamlanmış)</span><span class="sxs-lookup"><span data-stu-id="ff32d-392">**phase**: phase of the transfer (active or complete)</span></span>
- <span data-ttu-id="ff32d-393">**object_buffer**: nesne arabellek adresi</span><span class="sxs-lookup"><span data-stu-id="ff32d-393">**object_buffer**: Object buffer address</span></span>
- <span data-ttu-id="ff32d-394">**object_offset**: verilerin adresi</span><span class="sxs-lookup"><span data-stu-id="ff32d-394">**object_offset**: Address of data</span></span>
- <span data-ttu-id="ff32d-395">**object_length**: uygulama tarafından gönderilen nesne veri uzunluğu</span><span class="sxs-lookup"><span data-stu-id="ff32d-395">**object_length**: Object data length sent by application</span></span>

### <a name="example"></a><span data-ttu-id="ff32d-396">Örnek</span><span class="sxs-lookup"><span data-stu-id="ff32d-396">Example</span></span>
...
## <a name="ux_device_class_pima_object_delete"></a><span data-ttu-id="ff32d-397">ux_device_class_pima_object_delete</span><span class="sxs-lookup"><span data-stu-id="ff32d-397">ux_device_class_pima_object_delete</span></span>

<span data-ttu-id="ff32d-398">Yerel bir nesneyi silme</span><span class="sxs-lookup"><span data-stu-id="ff32d-398">Delete a local object</span></span>

### <a name="prototype"></a><span data-ttu-id="ff32d-399">Prototype</span><span class="sxs-lookup"><span data-stu-id="ff32d-399">Prototype</span></span>
...
### <a name="description"></a><span data-ttu-id="ff32d-400">Açıklama</span><span class="sxs-lookup"><span data-stu-id="ff32d-400">Description</span></span>

<span data-ttu-id="ff32d-401">Bu işlev, PIMA sınıfının yerel depolamadaki bir nesneyi silmesi gerektiğinde çağrılır.</span><span class="sxs-lookup"><span data-stu-id="ff32d-401">This function is called when the PIMA class needs to delete an object on the local storage.</span></span>

### <a name="parameters"></a><span data-ttu-id="ff32d-402">Parametreler</span><span class="sxs-lookup"><span data-stu-id="ff32d-402">Parameters</span></span>

- <span data-ttu-id="ff32d-403">**Pima**: Pima sınıfı örneğine yönelik işaretçi</span><span class="sxs-lookup"><span data-stu-id="ff32d-403">**pima**: Pointer to the pima class instance</span></span>
- <span data-ttu-id="ff32d-404">**object_handle**: nesnenin tanıtıcısı</span><span class="sxs-lookup"><span data-stu-id="ff32d-404">**object_handle**: Handle of the object</span></span>

### <a name="example"></a><span data-ttu-id="ff32d-405">Örnek</span><span class="sxs-lookup"><span data-stu-id="ff32d-405">Example</span></span>
...
## <a name="usb-device-audio-class"></a><span data-ttu-id="ff32d-406">USB cihaz ses sınıfı</span><span class="sxs-lookup"><span data-stu-id="ff32d-406">USB Device Audio Class</span></span>

<span data-ttu-id="ff32d-407">USB cihaz ses sınıfı, USB konak sisteminin cihazla bir ses cihazı olarak iletişim kurmasına olanak tanır.</span><span class="sxs-lookup"><span data-stu-id="ff32d-407">The USB device Audio class allows for a USB host system to communicate with the device as an audio device.</span></span> <span data-ttu-id="ff32d-408">Bu sınıf, USB Standart ve USB ses sınıfı 1,0 veya 2,0 standardını temel alır.</span><span class="sxs-lookup"><span data-stu-id="ff32d-408">This class is based on the USB standard and USB Audio Class 1.0 or 2.0 standard.</span></span>

<span data-ttu-id="ff32d-409">USB ses uyumlu bir cihaz çerçevesinin cihaz yığını tarafından bildirilmesine ihtiyacı vardır.</span><span class="sxs-lookup"><span data-stu-id="ff32d-409">A USB audio compliant device framework needs to be declared by the device stack.</span></span> <span data-ttu-id="ff32d-410">Ses 2,0 konuşmacı örneği aşağıda verilmiştir:</span><span class="sxs-lookup"><span data-stu-id="ff32d-410">An example of an Audio 2.0 speaker follows:</span></span>
...
<span data-ttu-id="ff32d-411">Ses sınıfı, arabirimleri gruplamak için bir bileşik cihaz çerçevesi kullanır (denetim ve akış).</span><span class="sxs-lookup"><span data-stu-id="ff32d-411">The Audio class uses a composite device framework to group interfaces (control and streaming).</span></span> <span data-ttu-id="ff32d-412">Bir sonuç olarak, cihaz tanımlayıcısı tanımlanırken alınması gerekir.</span><span class="sxs-lookup"><span data-stu-id="ff32d-412">As a result care should be taken when defining the device descriptor.</span></span> <span data-ttu-id="ff32d-413">USBX, dahili olarak arabirimlerin nasıl bağlanacağını öğrenmek için ıAD tanımlayıcısını kullanır.</span><span class="sxs-lookup"><span data-stu-id="ff32d-413">USBX relies on the IAD descriptor to know internally how to bind interfaces.</span></span> <span data-ttu-id="ff32d-414">IAD tanımlayıcısının, arabirimlerden önce (bir veya daha fazla AudioStreaming Interface tarafından izlenen bir veya daha fazla Audiostream arabirimi) önce bildirilmelidir ve ses sınıfının ilk arabirimini (AudioControl arabirimi) ve kaç arabirimin iliştirildiğine sahip olmalısınız.</span><span class="sxs-lookup"><span data-stu-id="ff32d-414">The IAD descriptor should be declared before the interfaces (an AudioControl interface followed by one or more AudioStreaming interfaces) and contain the first interface of the Audio class (the AudioControl interface) and how many interfaces are attached.</span></span>

<span data-ttu-id="ff32d-415">Ses sınıfının çalışma şekli, cihazın ses gönderip almayacağı, ancak her iki durumda da ses çerçevesi arabelleklerinin depolanması için bir FıFO kullanmasına bağlıdır: cihaz konağa ses gönderiyorsa, uygulama daha sonra USBX tarafından konağa gönderilen, daha sonra FıFO 'ya ses çerçevesi arabellekleri ekler. cihaz konaktan ses alıyorsa, USBX konaktan alınan ses çerçevesi arabelleklerini daha sonra uygulama tarafından okunan FıFO 'ya ekler.</span><span class="sxs-lookup"><span data-stu-id="ff32d-415">The way the audio class works depends on whether the device is sending or receiving audio, but both cases use a FIFO for storing audio frame buffers: if the device is sending audio to the host, then the application adds audio frame buffers to the FIFO which are later sent to the host by USBX; if the device is receiving audio from the host, then USBX adds the audio frame buffers received from the host to the FIFO which are later read by the application.</span></span> <span data-ttu-id="ff32d-416">Her ses akışının kendi FıFO 'u vardır ve her ses çerçevesi arabelleği birden çok örnek içerir.</span><span class="sxs-lookup"><span data-stu-id="ff32d-416">Each audio stream has its own FIFO, and each audio frame buffer consists of multiple samples.</span></span>

<span data-ttu-id="ff32d-417">Ses sınıfının başlatılması aşağıdaki parçaları bekler.</span><span class="sxs-lookup"><span data-stu-id="ff32d-417">The initialization of the Audio class expects the following parts.</span></span>

1. <span data-ttu-id="ff32d-418">Ses sınıfı aşağıdaki akış parametrelerini bekliyor:</span><span class="sxs-lookup"><span data-stu-id="ff32d-418">Audio class expects the following streaming parameters:</span></span>
...
2. <span data-ttu-id="ff32d-419">Ses sınıfı aşağıdaki işlev parametrelerini bekliyor.</span><span class="sxs-lookup"><span data-stu-id="ff32d-419">Audio class expects the following function parameters.</span></span>
   ...
   */
   ...
   <span data-ttu-id="ff32d-420">Yığın konaktan bir denetim isteği aldığında uygulama tanımlı denetim isteği geri araması (***ux_device_class_audio_control_process***; önceki örnekte ayarlanan) çağrılır.</span><span class="sxs-lookup"><span data-stu-id="ff32d-420">The application-defined control request callback (***ux_device_class_audio_control_process***; set in the previous example) is invoked when the stack receives a control request from the host.</span></span> <span data-ttu-id="ff32d-421">İstek kabul edildiğinde ve işlenirse (onaylanan veya durdurulmuş) geri çağırma başarılı döndürmelidir, aksi takdirde hata döndürülmelidir.</span><span class="sxs-lookup"><span data-stu-id="ff32d-421">If the request is accepted and handled (acknowledged or stalled) the callback must return success, otherwise error should be returned.</span></span>

   <span data-ttu-id="ff32d-422">Sınıfa özgü denetim isteği işlemi, bir uygulama tanımlı geri arama olarak tanımlanır çünkü denetim istekleri USB ses sürümleri arasında çok farklıdır ve istek işleminin büyük bir bölümü cihaz çerçevesiyle ilgilidir.</span><span class="sxs-lookup"><span data-stu-id="ff32d-422">The class-specific control request process is defined as an application-defined callback because the control requests are very different between USB Audio versions and a large part of the request process relates to the device framework.</span></span> <span data-ttu-id="ff32d-423">Uygulamanın, cihazı çalışır hale getirmek için istekleri doğru işlemesi gerekir.</span><span class="sxs-lookup"><span data-stu-id="ff32d-423">The application should handle requests correctly to make the device functional.</span></span>

   <span data-ttu-id="ff32d-424">Ses cihazı, ses, sessiz ve örnekleme sıklığı yaygın denetim istekleridir, ancak farklı USB ses sürümleri için basit ve dahili olarak tanımlanmış geri çağrılar, uygulamaların kullanması için sonraki bölümlerde sunulmuştur.</span><span class="sxs-lookup"><span data-stu-id="ff32d-424">Since for an audio device, volume, mute and sampling frequency are common control requests, simple, internally-defined callbacks for different USB audio versions are introduced in later sections for applications to use.</span></span> <span data-ttu-id="ff32d-425">Daha fazla ayrıntı için ***ux_device_class_audio10_control_process** _ ve _ *_ux_device_class_audio_control_request_** bölümüne bakın.</span><span class="sxs-lookup"><span data-stu-id="ff32d-425">Refer to ***ux_device_class_audio10_control_process** _ and _ *_ux_device_class_audio_control_request_** for more details.</span></span>

<span data-ttu-id="ff32d-426">Ses cihazının cihaz çerçevesinde, PID/VIP cihaz tanımlayıcısına depolanır (yukarıda belirtilen cihaz tanımlayıcısına bakın).</span><span class="sxs-lookup"><span data-stu-id="ff32d-426">In the device framework of the Audio device, the PID/VID are stored in the device descriptor (see the device descriptor declared above).</span></span>

<span data-ttu-id="ff32d-427">Bir USB ana bilgisayar sistemi, USB ses cihazını bulur ve ses sınıfını takar, cihaz herhangi bir ses yürütücüsü veya Kaydedicisi (çerçeveye bağlı olarak) ile kullanılabilir.</span><span class="sxs-lookup"><span data-stu-id="ff32d-427">When a USB host system discovers the USB Audio device and mounts the audio class, the device can be used with any audio player or recorder (depending on the framework).</span></span> <span data-ttu-id="ff32d-428">Başvuru için konak Işletim sistemine bakın.</span><span class="sxs-lookup"><span data-stu-id="ff32d-428">See the host Operating System for reference.</span></span>

<span data-ttu-id="ff32d-429">Ses sınıfı API 'Leri aşağıda tanımlanmıştır.</span><span class="sxs-lookup"><span data-stu-id="ff32d-429">The Audio class APIs are defined below.</span></span>

## <a name="ux_device_class_audio_read_thread_entry"></a><span data-ttu-id="ff32d-430">ux_device_class_audio_read_thread_entry</span><span class="sxs-lookup"><span data-stu-id="ff32d-430">ux_device_class_audio_read_thread_entry</span></span>

<span data-ttu-id="ff32d-431">Ses işlevine yönelik verileri okumak için iş parçacığı girişi.</span><span class="sxs-lookup"><span data-stu-id="ff32d-431">Thread entry for reading data for the Audio function.</span></span>

### <a name="prototype"></a><span data-ttu-id="ff32d-432">Prototype</span><span class="sxs-lookup"><span data-stu-id="ff32d-432">Prototype</span></span>

```C
VOID ux_device_class_audio_read_thread_entry(ULONG audio_stream);
```

### <a name="description"></a><span data-ttu-id="ff32d-433">Açıklama</span><span class="sxs-lookup"><span data-stu-id="ff32d-433">Description</span></span>

<span data-ttu-id="ff32d-434">Bu işlev, konaktan ses okuma isteniyorsa ses akışı başlatma parametresine geçirilir.</span><span class="sxs-lookup"><span data-stu-id="ff32d-434">This function is passed to the audio stream initialization parameter if reading audio from the host is desired.</span></span> <span data-ttu-id="ff32d-435">Dahili olarak, bu işlevle giriş işlevi olarak bir iş parçacığı oluşturulur; iş parçacığı, ses işlevindeki zaman aralıklı çıkış uç noktası aracılığıyla ses verilerini okur.</span><span class="sxs-lookup"><span data-stu-id="ff32d-435">Internally, a thread is created with this function as its entry function; the thread itself reads audio data through the isochronous OUT endpoint in the Audio function.</span></span>

### <a name="parameters"></a><span data-ttu-id="ff32d-436">Parametreler</span><span class="sxs-lookup"><span data-stu-id="ff32d-436">Parameters</span></span>

- <span data-ttu-id="ff32d-437">**audio_stream**: ses akışı örneğine yönelik işaretçi.</span><span class="sxs-lookup"><span data-stu-id="ff32d-437">**audio_stream**: Pointer to the audio stream instance.</span></span>

### <a name="example"></a><span data-ttu-id="ff32d-438">Örnek</span><span class="sxs-lookup"><span data-stu-id="ff32d-438">Example</span></span>
...
## <a name="ux_device_class_audio_write_thread_entry"></a><span data-ttu-id="ff32d-439">ux_device_class_audio_write_thread_entry</span><span class="sxs-lookup"><span data-stu-id="ff32d-439">ux_device_class_audio_write_thread_entry</span></span>

<span data-ttu-id="ff32d-440">Ses işlevine veri yazmak için iş parçacığı girişi</span><span class="sxs-lookup"><span data-stu-id="ff32d-440">Thread entry for writing data for the Audio function</span></span>

### <a name="prototype"></a><span data-ttu-id="ff32d-441">Prototype</span><span class="sxs-lookup"><span data-stu-id="ff32d-441">Prototype</span></span>

```C
VOID ux_device_class_audio_write_thread_entry(ULONG audio_stream);
```

### <a name="description"></a><span data-ttu-id="ff32d-442">Açıklama</span><span class="sxs-lookup"><span data-stu-id="ff32d-442">Description</span></span>

<span data-ttu-id="ff32d-443">Bu işlev, konağa ses yazılması isteniyorsa ses akışı başlatma parametresine geçirilir.</span><span class="sxs-lookup"><span data-stu-id="ff32d-443">This function is passed to the audio stream initialization parameter if writing audio to the host is desired.</span></span> <span data-ttu-id="ff32d-444">Dahili olarak, bu işlevle giriş işlevi olarak bir iş parçacığı oluşturulur; iş parçacığı, ses işlevindeki zaman aralıklı olarak ses verileri yazar.</span><span class="sxs-lookup"><span data-stu-id="ff32d-444">Internally, a thread is created with this function as its entry function; the thread itself writes audio data through the isochronous IN endpoint in the Audio function.</span></span>

### <a name="parameters"></a><span data-ttu-id="ff32d-445">Parametreler</span><span class="sxs-lookup"><span data-stu-id="ff32d-445">Parameters</span></span>

- <span data-ttu-id="ff32d-446">**audio_stream**: ses akışı örneğine yönelik işaretçi.</span><span class="sxs-lookup"><span data-stu-id="ff32d-446">**audio_stream**: Pointer to the audio stream instance.</span></span>

### <a name="example"></a><span data-ttu-id="ff32d-447">Örnek</span><span class="sxs-lookup"><span data-stu-id="ff32d-447">Example</span></span>
...
## <a name="ux_device_class_audio_stream_get"></a><span data-ttu-id="ff32d-448">ux_device_class_audio_stream_get</span><span class="sxs-lookup"><span data-stu-id="ff32d-448">ux_device_class_audio_stream_get</span></span>

<span data-ttu-id="ff32d-449">Ses işlevi için belirli bir akış örneği al</span><span class="sxs-lookup"><span data-stu-id="ff32d-449">Get specific stream instance for the Audio function</span></span>

### <a name="prototype"></a><span data-ttu-id="ff32d-450">Prototype</span><span class="sxs-lookup"><span data-stu-id="ff32d-450">Prototype</span></span>
...
### <a name="description"></a><span data-ttu-id="ff32d-451">Açıklama</span><span class="sxs-lookup"><span data-stu-id="ff32d-451">Description</span></span>

<span data-ttu-id="ff32d-452">Bu işlev, ses sınıfının akış örneğini almak için kullanılır.</span><span class="sxs-lookup"><span data-stu-id="ff32d-452">This function is used to get a stream instance of audio class.</span></span>

### <a name="parameters"></a><span data-ttu-id="ff32d-453">Parametreler</span><span class="sxs-lookup"><span data-stu-id="ff32d-453">Parameters</span></span>

- <span data-ttu-id="ff32d-454">**Ses**: ses örneğine yönelik işaretçi</span><span class="sxs-lookup"><span data-stu-id="ff32d-454">**audio**: Pointer to the audio instance</span></span>
- <span data-ttu-id="ff32d-455">**stream_index**: akış örneği dizini 0 ' a göre</span><span class="sxs-lookup"><span data-stu-id="ff32d-455">**stream_index**: Stream instance index based on 0</span></span>
- <span data-ttu-id="ff32d-456">**Stream**: ses akışı örneği işaretçisini depolamak için arabelleğin işaretçisi</span><span class="sxs-lookup"><span data-stu-id="ff32d-456">**stream**: Pointer to buffer to store the audio stream instance pointer</span></span>

### <a name="return-value"></a><span data-ttu-id="ff32d-457">Dönüş Değeri</span><span class="sxs-lookup"><span data-stu-id="ff32d-457">Return Value</span></span>

- <span data-ttu-id="ff32d-458">**UX_SUCCESS** (0x00) Bu işlem başarılı oldu</span><span class="sxs-lookup"><span data-stu-id="ff32d-458">**UX_SUCCESS** (0x00) This operation was successful</span></span>
- <span data-ttu-id="ff32d-459">İşlevden **UX_ERROR** (0xFF) hatası</span><span class="sxs-lookup"><span data-stu-id="ff32d-459">**UX_ERROR** (0xFF) Error from function</span></span>

### <a name="example"></a><span data-ttu-id="ff32d-460">Örnek</span><span class="sxs-lookup"><span data-stu-id="ff32d-460">Example</span></span>
...
## <a name="ux_device_class_audio_reception_start"></a><span data-ttu-id="ff32d-461">ux_device_class_audio_reception_start</span><span class="sxs-lookup"><span data-stu-id="ff32d-461">ux_device_class_audio_reception_start</span></span>

<span data-ttu-id="ff32d-462">Ses akışı için ses verilerini almayı Başlat</span><span class="sxs-lookup"><span data-stu-id="ff32d-462">Start audio data reception for the Audio stream</span></span>

### <a name="prototype"></a><span data-ttu-id="ff32d-463">Prototype</span><span class="sxs-lookup"><span data-stu-id="ff32d-463">Prototype</span></span>

```C
UINT ux_device_class_audio_reception_start(UX_DEVICE_CLASS_AUDIO_STREAM *stream);
```

### <a name="description"></a><span data-ttu-id="ff32d-464">Açıklama</span><span class="sxs-lookup"><span data-stu-id="ff32d-464">Description</span></span>

<span data-ttu-id="ff32d-465">Bu işlev, ses akışında okuma ses verilerini başlatmak için kullanılır.</span><span class="sxs-lookup"><span data-stu-id="ff32d-465">This function is used to start audio data reading in audio streams.</span></span>

### <a name="parameters"></a><span data-ttu-id="ff32d-466">Parametreler</span><span class="sxs-lookup"><span data-stu-id="ff32d-466">Parameters</span></span>

- <span data-ttu-id="ff32d-467">**Stream**: ses akışı örneğine yönelik işaretçi.</span><span class="sxs-lookup"><span data-stu-id="ff32d-467">**stream**: Pointer to the audio stream instance.</span></span>

### <a name="return-value"></a><span data-ttu-id="ff32d-468">Dönüş Değeri</span><span class="sxs-lookup"><span data-stu-id="ff32d-468">Return Value</span></span>

- <span data-ttu-id="ff32d-469">**UX_SUCCESS** (0x00) Bu işlem başarılı oldu.</span><span class="sxs-lookup"><span data-stu-id="ff32d-469">**UX_SUCCESS** (0x00) This operation was successful.</span></span>
- <span data-ttu-id="ff32d-470">**UX_CONFIGURATION_HANDLE_UNKNOWN** (0x51) arabirim çalışmıyor.</span><span class="sxs-lookup"><span data-stu-id="ff32d-470">**UX_CONFIGURATION_HANDLE_UNKNOWN** (0x51) The interface is down.</span></span>
- <span data-ttu-id="ff32d-471">**UX_BUFFER_OVERFLOW** (0x5D) FIFO arabelleği dolu.</span><span class="sxs-lookup"><span data-stu-id="ff32d-471">**UX_BUFFER_OVERFLOW** (0x5d) FIFO buffer is full.</span></span>
- <span data-ttu-id="ff32d-472">İşlevden **UX_ERROR** (0xFF) hatası</span><span class="sxs-lookup"><span data-stu-id="ff32d-472">**UX_ERROR** (0xFF) Error from function</span></span>

### <a name="example"></a><span data-ttu-id="ff32d-473">Örnek</span><span class="sxs-lookup"><span data-stu-id="ff32d-473">Example</span></span>
...
## <a name="ux_device_class_audio_sample_read8"></a><span data-ttu-id="ff32d-474">ux_device_class_audio_sample_read8</span><span class="sxs-lookup"><span data-stu-id="ff32d-474">ux_device_class_audio_sample_read8</span></span>

<span data-ttu-id="ff32d-475">Ses akışından 8 bit örneği oku</span><span class="sxs-lookup"><span data-stu-id="ff32d-475">Read 8-bit sample from the Audio stream</span></span>

### <a name="prototype"></a><span data-ttu-id="ff32d-476">Prototype</span><span class="sxs-lookup"><span data-stu-id="ff32d-476">Prototype</span></span>
...
### <a name="description"></a><span data-ttu-id="ff32d-477">Açıklama</span><span class="sxs-lookup"><span data-stu-id="ff32d-477">Description</span></span>

<span data-ttu-id="ff32d-478">Bu işlev, belirtilen akıştan 8 bit ses örnek verilerini okur.</span><span class="sxs-lookup"><span data-stu-id="ff32d-478">This function reads 8-bit audio sample data from the specified stream.</span></span>

<span data-ttu-id="ff32d-479">Özellikle, FıFO 'daki geçerli ses çerçevesi arabelleğindeki örnek verileri okur.</span><span class="sxs-lookup"><span data-stu-id="ff32d-479">Specifically, it reads the sample data from the current audio frame buffer in the FIFO.</span></span> <span data-ttu-id="ff32d-480">Bir ses çerçevesindeki son örneği okurken, ana bilgisayardan daha fazla veri kabul etmek için kullanılabilmesi için çerçeve otomatik olarak serbest bırakılır.</span><span class="sxs-lookup"><span data-stu-id="ff32d-480">Upon reading the last sample in an audio frame, the frame will be automatically freed so that it can be used to accept more data from the host.</span></span>

### <a name="parameters"></a><span data-ttu-id="ff32d-481">Parametreler</span><span class="sxs-lookup"><span data-stu-id="ff32d-481">Parameters</span></span>

- <span data-ttu-id="ff32d-482">**Stream**: ses akışı örneğine yönelik işaretçi.</span><span class="sxs-lookup"><span data-stu-id="ff32d-482">**stream**: Pointer to the audio stream instance.</span></span>
- <span data-ttu-id="ff32d-483">**buffer**: örnek baytı kaydetmek için arabelleğin işaretçisi.</span><span class="sxs-lookup"><span data-stu-id="ff32d-483">**buffer**: Pointer to the buffer to save sample byte.</span></span>

### <a name="return-value"></a><span data-ttu-id="ff32d-484">Dönüş Değeri</span><span class="sxs-lookup"><span data-stu-id="ff32d-484">Return Value</span></span>

- <span data-ttu-id="ff32d-485">**UX_SUCCESS** (0x00) Bu işlem başarılı oldu.</span><span class="sxs-lookup"><span data-stu-id="ff32d-485">**UX_SUCCESS** (0x00) This operation was successful.</span></span>
- <span data-ttu-id="ff32d-486">**UX_CONFIGURATION_HANDLE_UNKNOWN** (0x51) arabirim çalışmıyor.</span><span class="sxs-lookup"><span data-stu-id="ff32d-486">**UX_CONFIGURATION_HANDLE_UNKNOWN** (0x51) The interface is down.</span></span>
- <span data-ttu-id="ff32d-487">**UX_BUFFER_OVERFLOW** (0x5D) FIFO arabelleği null.</span><span class="sxs-lookup"><span data-stu-id="ff32d-487">**UX_BUFFER_OVERFLOW** (0x5d) FIFO buffer is null.</span></span>
- <span data-ttu-id="ff32d-488">İşlevden **UX_ERROR** (0xFF) hatası</span><span class="sxs-lookup"><span data-stu-id="ff32d-488">**UX_ERROR** (0xFF) Error from function</span></span>

### <a name="example"></a><span data-ttu-id="ff32d-489">Örnek</span><span class="sxs-lookup"><span data-stu-id="ff32d-489">Example</span></span>
...
## <a name="ux_device_class_audio_sample_read16"></a><span data-ttu-id="ff32d-490">ux_device_class_audio_sample_read16</span><span class="sxs-lookup"><span data-stu-id="ff32d-490">ux_device_class_audio_sample_read16</span></span>

<span data-ttu-id="ff32d-491">Ses akışından 16 bit örneği oku</span><span class="sxs-lookup"><span data-stu-id="ff32d-491">Read 16-bit sample from the Audio stream</span></span>

### <a name="prototype"></a><span data-ttu-id="ff32d-492">Prototype</span><span class="sxs-lookup"><span data-stu-id="ff32d-492">Prototype</span></span>
...
### <a name="description"></a><span data-ttu-id="ff32d-493">Açıklama</span><span class="sxs-lookup"><span data-stu-id="ff32d-493">Description</span></span>

<span data-ttu-id="ff32d-494">Bu işlev, belirtilen akıştan 16 bit ses örnek verilerini okur.</span><span class="sxs-lookup"><span data-stu-id="ff32d-494">This function reads 16-bit audio sample data from the specified stream.</span></span>

<span data-ttu-id="ff32d-495">Özellikle, FıFO 'daki geçerli ses çerçevesi arabelleğindeki örnek verileri okur.</span><span class="sxs-lookup"><span data-stu-id="ff32d-495">Specifically, it reads the sample data from the current audio frame buffer in the FIFO.</span></span> <span data-ttu-id="ff32d-496">Bir ses çerçevesindeki son örneği okurken, ana bilgisayardan daha fazla veri kabul etmek için kullanılabilmesi için çerçeve otomatik olarak serbest bırakılır.</span><span class="sxs-lookup"><span data-stu-id="ff32d-496">Upon reading the last sample in an audio frame, the frame will be automatically freed so that it can be used to accept more data from the host.</span></span>

### <a name="parameters"></a><span data-ttu-id="ff32d-497">Parametreler</span><span class="sxs-lookup"><span data-stu-id="ff32d-497">Parameters</span></span>

- <span data-ttu-id="ff32d-498">**Stream**: ses akışı örneğine yönelik işaretçi.</span><span class="sxs-lookup"><span data-stu-id="ff32d-498">**stream**: Pointer to the audio stream instance.</span></span>
- <span data-ttu-id="ff32d-499">**buffer**: 16 bit örneği kaydetmek için arabelleğin işaretçisi.</span><span class="sxs-lookup"><span data-stu-id="ff32d-499">**buffer**: Pointer to the buffer to save the 16-bit sample.</span></span>

### <a name="return-value"></a><span data-ttu-id="ff32d-500">Dönüş Değeri</span><span class="sxs-lookup"><span data-stu-id="ff32d-500">Return Value</span></span>

- <span data-ttu-id="ff32d-501">**UX_SUCCESS** (0x00) Bu işlem başarılı oldu.</span><span class="sxs-lookup"><span data-stu-id="ff32d-501">**UX_SUCCESS** (0x00) This operation was successful.</span></span>
- <span data-ttu-id="ff32d-502">**UX_CONFIGURATION_HANDLE_UNKNOWN** (0x51) arabirim çalışmıyor.</span><span class="sxs-lookup"><span data-stu-id="ff32d-502">**UX_CONFIGURATION_HANDLE_UNKNOWN** (0x51) The interface is down.</span></span>
- <span data-ttu-id="ff32d-503">**UX_BUFFER_OVERFLOW** (0x5D) FIFO arabelleği null.</span><span class="sxs-lookup"><span data-stu-id="ff32d-503">**UX_BUFFER_OVERFLOW** (0x5d) FIFO buffer is null.</span></span>
- <span data-ttu-id="ff32d-504">İşlevden **UX_ERROR** (0xFF) hatası</span><span class="sxs-lookup"><span data-stu-id="ff32d-504">**UX_ERROR** (0xFF) Error from function</span></span>

### <a name="example"></a><span data-ttu-id="ff32d-505">Örnek</span><span class="sxs-lookup"><span data-stu-id="ff32d-505">Example</span></span>
...
## <a name="ux_device_class_audio_sample_read24"></a><span data-ttu-id="ff32d-506">ux_device_class_audio_sample_read24</span><span class="sxs-lookup"><span data-stu-id="ff32d-506">ux_device_class_audio_sample_read24</span></span>

<span data-ttu-id="ff32d-507">Ses akışından 24 bit örnek okuyun</span><span class="sxs-lookup"><span data-stu-id="ff32d-507">Read 24-bit sample from the Audio stream</span></span>

### <a name="prototype"></a><span data-ttu-id="ff32d-508">Prototype</span><span class="sxs-lookup"><span data-stu-id="ff32d-508">Prototype</span></span>
...
### <a name="description"></a><span data-ttu-id="ff32d-509">Açıklama</span><span class="sxs-lookup"><span data-stu-id="ff32d-509">Description</span></span>

<span data-ttu-id="ff32d-510">Bu işlev, belirtilen akıştan alınan 24 bit ses örnek verilerini okur.</span><span class="sxs-lookup"><span data-stu-id="ff32d-510">This function reads 24-bit audio sample data from the specified stream.</span></span>

<span data-ttu-id="ff32d-511">Özellikle, FıFO 'daki geçerli ses çerçevesi arabelleğindeki örnek verileri okur.</span><span class="sxs-lookup"><span data-stu-id="ff32d-511">Specifically, it reads the sample data from the current audio frame buffer in the FIFO.</span></span> <span data-ttu-id="ff32d-512">Bir ses çerçevesindeki son örneği okurken, ana bilgisayardan daha fazla veri kabul etmek için kullanılabilmesi için çerçeve otomatik olarak serbest bırakılır.</span><span class="sxs-lookup"><span data-stu-id="ff32d-512">Upon reading the last sample in an audio frame, the frame will be automatically freed so that it can be used to accept more data from the host.</span></span>

### <a name="parameters"></a><span data-ttu-id="ff32d-513">Parametreler</span><span class="sxs-lookup"><span data-stu-id="ff32d-513">Parameters</span></span>

- <span data-ttu-id="ff32d-514">**Stream**: ses akışı örneğine yönelik işaretçi.</span><span class="sxs-lookup"><span data-stu-id="ff32d-514">**stream**: Pointer to the audio stream instance.</span></span>
- <span data-ttu-id="ff32d-515">**buffer**: 3 baytlık örneği kaydetmek için arabelleğin işaretçisi.</span><span class="sxs-lookup"><span data-stu-id="ff32d-515">**buffer**: Pointer to the buffer to save the 3-byte sample.</span></span>

### <a name="return-value"></a><span data-ttu-id="ff32d-516">Dönüş Değeri</span><span class="sxs-lookup"><span data-stu-id="ff32d-516">Return Value</span></span>

- <span data-ttu-id="ff32d-517">**UX_SUCCESS** (0x00) Bu işlem başarılı oldu.</span><span class="sxs-lookup"><span data-stu-id="ff32d-517">**UX_SUCCESS** (0x00) This operation was successful.</span></span>
- <span data-ttu-id="ff32d-518">**UX_CONFIGURATION_HANDLE_UNKNOWN** (0x51) arabirim çalışmıyor.</span><span class="sxs-lookup"><span data-stu-id="ff32d-518">**UX_CONFIGURATION_HANDLE_UNKNOWN** (0x51) The interface is down.</span></span>
- <span data-ttu-id="ff32d-519">**UX_BUFFER_OVERFLOW** (0x5D) FIFO arabelleği null.</span><span class="sxs-lookup"><span data-stu-id="ff32d-519">**UX_BUFFER_OVERFLOW** (0x5d) FIFO buffer is null.</span></span>
- <span data-ttu-id="ff32d-520">İşlevden **UX_ERROR** (0xFF) hatası</span><span class="sxs-lookup"><span data-stu-id="ff32d-520">**UX_ERROR** (0xFF) Error from function</span></span>

### <a name="example"></a><span data-ttu-id="ff32d-521">Örnek</span><span class="sxs-lookup"><span data-stu-id="ff32d-521">Example</span></span>
...
## <a name="ux_device_class_audio_sample_read32"></a><span data-ttu-id="ff32d-522">ux_device_class_audio_sample_read32</span><span class="sxs-lookup"><span data-stu-id="ff32d-522">ux_device_class_audio_sample_read32</span></span>

<span data-ttu-id="ff32d-523">Ses akışından 32 bitlik örnek okuyun</span><span class="sxs-lookup"><span data-stu-id="ff32d-523">Read 32-bit sample from the Audio stream</span></span>

### <a name="prototype"></a><span data-ttu-id="ff32d-524">Prototype</span><span class="sxs-lookup"><span data-stu-id="ff32d-524">Prototype</span></span>
...
### <a name="description"></a><span data-ttu-id="ff32d-525">Açıklama</span><span class="sxs-lookup"><span data-stu-id="ff32d-525">Description</span></span>

<span data-ttu-id="ff32d-526">Bu işlev, belirtilen akıştan 32 bitlik ses örnek verilerini okur.</span><span class="sxs-lookup"><span data-stu-id="ff32d-526">This function reads 32-bit audio sample data from the specified stream.</span></span>

<span data-ttu-id="ff32d-527">Özellikle, FıFO 'daki geçerli ses çerçevesi arabelleğindeki örnek verileri okur.</span><span class="sxs-lookup"><span data-stu-id="ff32d-527">Specifically, it reads the sample data from the current audio frame buffer in the FIFO.</span></span> <span data-ttu-id="ff32d-528">Bir ses çerçevesindeki son örneği okurken, ana bilgisayardan daha fazla veri kabul etmek için kullanılabilmesi için çerçeve otomatik olarak serbest bırakılır.</span><span class="sxs-lookup"><span data-stu-id="ff32d-528">Upon reading the last sample in an audio frame, the frame will be automatically freed so that it can be used to accept more data from the host.</span></span>

### <a name="parameters"></a><span data-ttu-id="ff32d-529">Parametreler</span><span class="sxs-lookup"><span data-stu-id="ff32d-529">Parameters</span></span>

- <span data-ttu-id="ff32d-530">**Stream**: ses akışı örneğine yönelik işaretçi.</span><span class="sxs-lookup"><span data-stu-id="ff32d-530">**stream**: Pointer to the audio stream instance.</span></span>
- <span data-ttu-id="ff32d-531">**buffer**: 4 baytlık verileri kaydetmek için arabelleğin işaretçisi.</span><span class="sxs-lookup"><span data-stu-id="ff32d-531">**buffer**: Pointer to the buffer to save the 4-byte data.</span></span>

### <a name="return-value"></a><span data-ttu-id="ff32d-532">Dönüş Değeri</span><span class="sxs-lookup"><span data-stu-id="ff32d-532">Return Value</span></span>

- <span data-ttu-id="ff32d-533">**UX_SUCCESS** (0x00) Bu işlem başarılı oldu.</span><span class="sxs-lookup"><span data-stu-id="ff32d-533">**UX_SUCCESS** (0x00) This operation was successful.</span></span>
- <span data-ttu-id="ff32d-534">**UX_CONFIGURATION_HANDLE_UNKNOWN** (0x51) arabirim çalışmıyor.</span><span class="sxs-lookup"><span data-stu-id="ff32d-534">**UX_CONFIGURATION_HANDLE_UNKNOWN** (0x51) The interface is down.</span></span>
- <span data-ttu-id="ff32d-535">**UX_BUFFER_OVERFLOW** (0x5D) FIFO arabelleği null.</span><span class="sxs-lookup"><span data-stu-id="ff32d-535">**UX_BUFFER_OVERFLOW** (0x5d) FIFO buffer is null.</span></span>
- <span data-ttu-id="ff32d-536">İşlevden **UX_ERROR** (0xFF) hatası</span><span class="sxs-lookup"><span data-stu-id="ff32d-536">**UX_ERROR** (0xFF) Error from function</span></span>

### <a name="example"></a><span data-ttu-id="ff32d-537">Örnek</span><span class="sxs-lookup"><span data-stu-id="ff32d-537">Example</span></span>
...
## <a name="ux_device_class_audio_read_frame_get"></a><span data-ttu-id="ff32d-538">ux_device_class_audio_read_frame_get</span><span class="sxs-lookup"><span data-stu-id="ff32d-538">ux_device_class_audio_read_frame_get</span></span>

<span data-ttu-id="ff32d-539">Ses akışındaki ses çerçevesine erişim sağlayın</span><span class="sxs-lookup"><span data-stu-id="ff32d-539">Get access to audio frame in the Audio stream</span></span>

### <a name="prototype"></a><span data-ttu-id="ff32d-540">Prototype</span><span class="sxs-lookup"><span data-stu-id="ff32d-540">Prototype</span></span>
...
### <a name="description"></a><span data-ttu-id="ff32d-541">Açıklama</span><span class="sxs-lookup"><span data-stu-id="ff32d-541">Description</span></span>

<span data-ttu-id="ff32d-542">Bu işlev, ilk ses çerçevesi arabelleğini ve belirtilen akışın FıFO uzunluğunu döndürür.</span><span class="sxs-lookup"><span data-stu-id="ff32d-542">This function returns the first audio frame buffer and its length in the specified stream's FIFO.</span></span> <span data-ttu-id="ff32d-543">Uygulama verileri işlemeyi tamamladıktan sonra FıFO 'daki çerçeve arabelleğini serbest bırakmak için ux_device_class_audio_read_frame_free kullanılmalıdır.</span><span class="sxs-lookup"><span data-stu-id="ff32d-543">When the application is done processing the data, ux_device_class_audio_read_frame_free must be used to free the frame buffer in the FIFO.</span></span>

### <a name="parameters"></a><span data-ttu-id="ff32d-544">Parametreler</span><span class="sxs-lookup"><span data-stu-id="ff32d-544">Parameters</span></span>

- <span data-ttu-id="ff32d-545">**Stream**: ses akışı örneğine yönelik işaretçi.</span><span class="sxs-lookup"><span data-stu-id="ff32d-545">**stream**: Pointer to the audio stream instance.</span></span>
- <span data-ttu-id="ff32d-546">**frame_data**: veri işaretçisini döndürmek için veri işaretçisine yönelik işaretçi.</span><span class="sxs-lookup"><span data-stu-id="ff32d-546">**frame_data**: Pointer to data pointer to return the data pointer in.</span></span>
- <span data-ttu-id="ff32d-547">**frame_length**: çerçeve uzunluğunu bayt sayısıyla kaydetmek için arabelleğin işaretçisi.</span><span class="sxs-lookup"><span data-stu-id="ff32d-547">**frame_length**: Pointer to buffer to save the frame length in number of bytes.</span></span>

### <a name="return-value"></a><span data-ttu-id="ff32d-548">Dönüş Değeri</span><span class="sxs-lookup"><span data-stu-id="ff32d-548">Return Value</span></span>

- <span data-ttu-id="ff32d-549">**UX_SUCCESS** (0x00) Bu işlem başarılı oldu.</span><span class="sxs-lookup"><span data-stu-id="ff32d-549">**UX_SUCCESS** (0x00) This operation was successful.</span></span>
- <span data-ttu-id="ff32d-550">**UX_CONFIGURATION_HANDLE_UNKNOWN** (0x51) arabirim çalışmıyor.</span><span class="sxs-lookup"><span data-stu-id="ff32d-550">**UX_CONFIGURATION_HANDLE_UNKNOWN** (0x51) The interface is down.</span></span>
- <span data-ttu-id="ff32d-551">**UX_BUFFER_OVERFLOW** (0x5D) FIFO arabelleği null.</span><span class="sxs-lookup"><span data-stu-id="ff32d-551">**UX_BUFFER_OVERFLOW** (0x5d) FIFO buffer is null.</span></span>
- <span data-ttu-id="ff32d-552">İşlevden **UX_ERROR** (0xFF) hatası</span><span class="sxs-lookup"><span data-stu-id="ff32d-552">**UX_ERROR** (0xFF) Error from function</span></span>

### <a name="example"></a><span data-ttu-id="ff32d-553">Örnek</span><span class="sxs-lookup"><span data-stu-id="ff32d-553">Example</span></span>
...
## <a name="ux_device_class_audio_read_frame_free"></a><span data-ttu-id="ff32d-554">ux_device_class_audio_read_frame_free</span><span class="sxs-lookup"><span data-stu-id="ff32d-554">ux_device_class_audio_read_frame_free</span></span>

<span data-ttu-id="ff32d-555">Ses akışında ses çerçevesi arabelleğini serbest bırakma</span><span class="sxs-lookup"><span data-stu-id="ff32d-555">Free an audio frame buffer in Audio stream</span></span>

### <a name="prototype"></a><span data-ttu-id="ff32d-556">Prototype</span><span class="sxs-lookup"><span data-stu-id="ff32d-556">Prototype</span></span>

```C
UINT ux_device_class_audio_read_frame_free(UX_DEVICE_CLASS_AUDIO_STREAM *stream);
```

### <a name="description"></a><span data-ttu-id="ff32d-557">Açıklama</span><span class="sxs-lookup"><span data-stu-id="ff32d-557">Description</span></span>

<span data-ttu-id="ff32d-558">Bu işlev, ana bilgisayardan veri alabilmesi için belirtilen akışın FıFO önünde ses çerçevesi arabelleğini serbest bırakır.</span><span class="sxs-lookup"><span data-stu-id="ff32d-558">This function frees the audio frame buffer at the front of the specified stream's FIFO so that it can receive data from the host.</span></span>

### <a name="parameters"></a><span data-ttu-id="ff32d-559">Parametreler</span><span class="sxs-lookup"><span data-stu-id="ff32d-559">Parameters</span></span>

- <span data-ttu-id="ff32d-560">**Stream**: ses akışı örneğine yönelik işaretçi.</span><span class="sxs-lookup"><span data-stu-id="ff32d-560">**stream**: Pointer to the audio stream instance.</span></span>

### <a name="return-value"></a><span data-ttu-id="ff32d-561">Dönüş Değeri</span><span class="sxs-lookup"><span data-stu-id="ff32d-561">Return Value</span></span>

- <span data-ttu-id="ff32d-562">**UX_SUCCESS** (0x00) Bu işlem başarılı oldu.</span><span class="sxs-lookup"><span data-stu-id="ff32d-562">**UX_SUCCESS** (0x00) This operation was successful.</span></span>
- <span data-ttu-id="ff32d-563">**UX_CONFIGURATION_HANDLE_UNKNOWN** (0x51) arabirim çalışmıyor.</span><span class="sxs-lookup"><span data-stu-id="ff32d-563">**UX_CONFIGURATION_HANDLE_UNKNOWN** (0x51) The interface is down.</span></span>
- <span data-ttu-id="ff32d-564">**UX_BUFFER_OVERFLOW** (0x5D) FIFO arabelleği null.</span><span class="sxs-lookup"><span data-stu-id="ff32d-564">**UX_BUFFER_OVERFLOW** (0x5d) FIFO buffer is null.</span></span>
- <span data-ttu-id="ff32d-565">İşlevden **UX_ERROR** (0xFF) hatası</span><span class="sxs-lookup"><span data-stu-id="ff32d-565">**UX_ERROR** (0xFF) Error from function</span></span>

### <a name="example"></a><span data-ttu-id="ff32d-566">Örnek</span><span class="sxs-lookup"><span data-stu-id="ff32d-566">Example</span></span>
...
## <a name="ux_device_class_audio_transmission_start"></a><span data-ttu-id="ff32d-567">ux_device_class_audio_transmission_start</span><span class="sxs-lookup"><span data-stu-id="ff32d-567">ux_device_class_audio_transmission_start</span></span>

<span data-ttu-id="ff32d-568">Ses akışı için ses veri aktarımını Başlat</span><span class="sxs-lookup"><span data-stu-id="ff32d-568">Start audio data transmission for the Audio stream</span></span>

### <a name="prototype"></a><span data-ttu-id="ff32d-569">Prototype</span><span class="sxs-lookup"><span data-stu-id="ff32d-569">Prototype</span></span>

```C
UINT ux_device_class_audio_transmission_start(UX_DEVICE_CLASS_AUDIO_STREAM *stream);
```

### <a name="description"></a><span data-ttu-id="ff32d-570">Açıklama</span><span class="sxs-lookup"><span data-stu-id="ff32d-570">Description</span></span>

<span data-ttu-id="ff32d-571">Bu işlev, ses sınıfında FıFO 'ya yazılmış ses verileri göndermeye başlamak için kullanılır.</span><span class="sxs-lookup"><span data-stu-id="ff32d-571">This function is used to start sending audio data written to the FIFO in the audio class.</span></span>

### <a name="parameters"></a><span data-ttu-id="ff32d-572">Parametreler</span><span class="sxs-lookup"><span data-stu-id="ff32d-572">Parameters</span></span>

- <span data-ttu-id="ff32d-573">**Stream**: ses akışı örneğine yönelik işaretçi.</span><span class="sxs-lookup"><span data-stu-id="ff32d-573">**stream**: Pointer to the audio stream instance.</span></span>

### <a name="return-value"></a><span data-ttu-id="ff32d-574">Dönüş Değeri</span><span class="sxs-lookup"><span data-stu-id="ff32d-574">Return Value</span></span>

- <span data-ttu-id="ff32d-575">**UX_SUCCESS** (0x00) Bu işlem başarılı oldu.</span><span class="sxs-lookup"><span data-stu-id="ff32d-575">**UX_SUCCESS** (0x00) This operation was successful.</span></span>
- <span data-ttu-id="ff32d-576">**UX_CONFIGURATION_HANDLE_UNKNOWN** (0x51) arabirim çalışmıyor.</span><span class="sxs-lookup"><span data-stu-id="ff32d-576">**UX_CONFIGURATION_HANDLE_UNKNOWN** (0x51) The interface is down.</span></span>
- <span data-ttu-id="ff32d-577">**UX_BUFFER_OVERFLOW** (0x5D) FIFO arabelleği null.</span><span class="sxs-lookup"><span data-stu-id="ff32d-577">**UX_BUFFER_OVERFLOW** (0x5d) FIFO buffer is null.</span></span>
- <span data-ttu-id="ff32d-578">İşlevden **UX_ERROR** (0xFF) hatası</span><span class="sxs-lookup"><span data-stu-id="ff32d-578">**UX_ERROR** (0xFF) Error from function</span></span>

### <a name="example"></a><span data-ttu-id="ff32d-579">Örnek</span><span class="sxs-lookup"><span data-stu-id="ff32d-579">Example</span></span>
...
## <a name="ux_device_class_audio_frame_write"></a><span data-ttu-id="ff32d-580">ux_device_class_audio_frame_write</span><span class="sxs-lookup"><span data-stu-id="ff32d-580">ux_device_class_audio_frame_write</span></span>

<span data-ttu-id="ff32d-581">Ses akışına bir ses çerçevesi yazma</span><span class="sxs-lookup"><span data-stu-id="ff32d-581">Write an audio frame into the Audio stream</span></span>

### <a name="prototype"></a><span data-ttu-id="ff32d-582">Prototype</span><span class="sxs-lookup"><span data-stu-id="ff32d-582">Prototype</span></span>
...
### <a name="description"></a><span data-ttu-id="ff32d-583">Açıklama</span><span class="sxs-lookup"><span data-stu-id="ff32d-583">Description</span></span>

<span data-ttu-id="ff32d-584">Bu işlev, ses akışının FıFO ' a bir çerçeve yazar.</span><span class="sxs-lookup"><span data-stu-id="ff32d-584">This function writes a frame to the audio stream's FIFO.</span></span> <span data-ttu-id="ff32d-585">Çerçeve verileri, konağa gönderilebilmesi için FıFO 'daki kullanılabilir arabelleğe kopyalanır.</span><span class="sxs-lookup"><span data-stu-id="ff32d-585">The frame data is copied to the available buffer in the FIFO so that it can be sent to the host.</span></span>

### <a name="parameters"></a><span data-ttu-id="ff32d-586">Parametreler</span><span class="sxs-lookup"><span data-stu-id="ff32d-586">Parameters</span></span>

- <span data-ttu-id="ff32d-587">**Stream**: ses akışı örneğine yönelik işaretçi.</span><span class="sxs-lookup"><span data-stu-id="ff32d-587">**stream**: Pointer to the audio stream instance.</span></span>
- <span data-ttu-id="ff32d-588">**çerçeve**: çerçeve verileri işaretçisi.</span><span class="sxs-lookup"><span data-stu-id="ff32d-588">**frame**: Pointer to frame data.</span></span>
- <span data-ttu-id="ff32d-589">**frame_length** Bayt sayısıyla çerçeve uzunluğu.</span><span class="sxs-lookup"><span data-stu-id="ff32d-589">**frame_length** Frame length in number of bytes.</span></span>

### <a name="return-value"></a><span data-ttu-id="ff32d-590">Dönüş Değeri</span><span class="sxs-lookup"><span data-stu-id="ff32d-590">Return Value</span></span>

- <span data-ttu-id="ff32d-591">**UX_SUCCESS** (0x00) Bu işlem başarılı oldu.</span><span class="sxs-lookup"><span data-stu-id="ff32d-591">**UX_SUCCESS** (0x00) This operation was successful.</span></span>
- <span data-ttu-id="ff32d-592">**UX_CONFIGURATION_HANDLE_UNKNOWN** (0x51) arabirim çalışmıyor.</span><span class="sxs-lookup"><span data-stu-id="ff32d-592">**UX_CONFIGURATION_HANDLE_UNKNOWN** (0x51) The interface is down.</span></span>
- <span data-ttu-id="ff32d-593">**UX_BUFFER_OVERFLOW** (0x5D) FIFO arabelleği dolu.</span><span class="sxs-lookup"><span data-stu-id="ff32d-593">**UX_BUFFER_OVERFLOW** (0x5d) FIFO buffer is full.</span></span>
- <span data-ttu-id="ff32d-594">İşlevden **UX_ERROR** (0xFF) hatası</span><span class="sxs-lookup"><span data-stu-id="ff32d-594">**UX_ERROR** (0xFF) Error from function</span></span>

### <a name="example"></a><span data-ttu-id="ff32d-595">Örnek</span><span class="sxs-lookup"><span data-stu-id="ff32d-595">Example</span></span>
...
## <a name="ux_device_class_audio_write_frame_get"></a><span data-ttu-id="ff32d-596">ux_device_class_audio_write_frame_get</span><span class="sxs-lookup"><span data-stu-id="ff32d-596">ux_device_class_audio_write_frame_get</span></span>

<span data-ttu-id="ff32d-597">Ses akışındaki ses çerçevesine erişim sağlayın</span><span class="sxs-lookup"><span data-stu-id="ff32d-597">Get access to audio frame in the Audio stream</span></span>

### <a name="prototype"></a><span data-ttu-id="ff32d-598">Prototype</span><span class="sxs-lookup"><span data-stu-id="ff32d-598">Prototype</span></span>
...
### <a name="description"></a><span data-ttu-id="ff32d-599">Açıklama</span><span class="sxs-lookup"><span data-stu-id="ff32d-599">Description</span></span>

<span data-ttu-id="ff32d-600">Bu işlev, FıFO 'nun son ses çerçevesi arabelleğinin adresini alır; Ayrıca, ses çerçevesi arabelleğinin uzunluğunu da alır.</span><span class="sxs-lookup"><span data-stu-id="ff32d-600">This function retrieves the address of the last audio frame buffer of the FIFO; it also retrieves the length of the audio frame buffer.</span></span> <span data-ttu-id="ff32d-601">Uygulama, ses çerçevesi arabelleğini istenen verilerle doldurduktan sonra, ***ux_device_class_audio_write_frame_commit*** kare arabelleği eklemek/FIFO 'ya uygulamak için kullanılmalıdır.</span><span class="sxs-lookup"><span data-stu-id="ff32d-601">After the application fills the audio frame buffer with its desired data, ***ux_device_class_audio_write_frame_commit*** must be used to add/commit the frame buffer to the FIFO.</span></span>

### <a name="parameters"></a><span data-ttu-id="ff32d-602">Parametreler</span><span class="sxs-lookup"><span data-stu-id="ff32d-602">Parameters</span></span>

- <span data-ttu-id="ff32d-603">**Stream**: ses akışı örneğine yönelik işaretçi.</span><span class="sxs-lookup"><span data-stu-id="ff32d-603">**stream**: Pointer to the audio stream instance.</span></span>
- <span data-ttu-id="ff32d-604">**frame_data**: çerçeve verisi işaretçisini döndürmek için çerçeve verisi işaretçisine yönelik işaretçi.</span><span class="sxs-lookup"><span data-stu-id="ff32d-604">**frame_data**: Pointer to frame data pointer to return the frame data pointer in.</span></span>
- <span data-ttu-id="ff32d-605">**frame_length** Çerçeve uzunluğunu bayt sayısıyla kaydetmek için arabelleğin işaretçisi.</span><span class="sxs-lookup"><span data-stu-id="ff32d-605">**frame_length** Pointer to the buffer to save frame length in number of bytes .</span></span>

### <a name="return-value"></a><span data-ttu-id="ff32d-606">Dönüş Değeri</span><span class="sxs-lookup"><span data-stu-id="ff32d-606">Return Value</span></span>

- <span data-ttu-id="ff32d-607">**UX_SUCCESS** (0x00) Bu işlem başarılı oldu.</span><span class="sxs-lookup"><span data-stu-id="ff32d-607">**UX_SUCCESS** (0x00) This operation was successful.</span></span>
- <span data-ttu-id="ff32d-608">**UX_CONFIGURATION_HANDLE_UNKNOWN** (0x51) arabirim çalışmıyor.</span><span class="sxs-lookup"><span data-stu-id="ff32d-608">**UX_CONFIGURATION_HANDLE_UNKNOWN** (0x51) The interface is down.</span></span>
- <span data-ttu-id="ff32d-609">**UX_BUFFER_OVERFLOW** (0x5D) FIFO arabelleği dolu.</span><span class="sxs-lookup"><span data-stu-id="ff32d-609">**UX_BUFFER_OVERFLOW** (0x5d) FIFO buffer is full.</span></span>
- <span data-ttu-id="ff32d-610">İşlevden **UX_ERROR** (0xFF) hatası</span><span class="sxs-lookup"><span data-stu-id="ff32d-610">**UX_ERROR** (0xFF) Error from function</span></span>

### <a name="example"></a><span data-ttu-id="ff32d-611">Örnek</span><span class="sxs-lookup"><span data-stu-id="ff32d-611">Example</span></span>
...
## <a name="ux_device_class_audio_write_frame_commit"></a><span data-ttu-id="ff32d-612">ux_device_class_audio_write_frame_commit</span><span class="sxs-lookup"><span data-stu-id="ff32d-612">ux_device_class_audio_write_frame_commit</span></span>

<span data-ttu-id="ff32d-613">Ses akışına ses çerçevesi arabelleği yürütün.</span><span class="sxs-lookup"><span data-stu-id="ff32d-613">Commit an audio frame buffer in Audio stream.</span></span>

### <a name="prototype"></a><span data-ttu-id="ff32d-614">Prototype</span><span class="sxs-lookup"><span data-stu-id="ff32d-614">Prototype</span></span>
...
### <a name="description"></a><span data-ttu-id="ff32d-615">Açıklama</span><span class="sxs-lookup"><span data-stu-id="ff32d-615">Description</span></span>

<span data-ttu-id="ff32d-616">Bu işlev, arabellek konağa aktarılmaya hazırlandığından, son ses çerçevesi arabelleğini FıFO 'ya ekler/kaydeder; son ses çerçevesi arabelleğinin ux_device_class_write_frame_get ile doldurulmuş olması gerektiğini göz önünde bulabilirsiniz.</span><span class="sxs-lookup"><span data-stu-id="ff32d-616">This function adds/commits the last audio frame buffer to the FIFO so the buffer is ready to be transferred to host; note the last audio frame buffer should have been filled out via ux_device_class_write_frame_get.</span></span>

### <a name="parameters"></a><span data-ttu-id="ff32d-617">Parametreler</span><span class="sxs-lookup"><span data-stu-id="ff32d-617">Parameters</span></span>

- <span data-ttu-id="ff32d-618">**Stream**: ses akışı örneğine yönelik işaretçi.</span><span class="sxs-lookup"><span data-stu-id="ff32d-618">**stream**: Pointer to the audio stream instance.</span></span>
- <span data-ttu-id="ff32d-619">**uzunluk**: arabellekte Ready bayt sayısı.</span><span class="sxs-lookup"><span data-stu-id="ff32d-619">**length**: Number of bytes ready in the buffer.</span></span>

### <a name="return-value"></a><span data-ttu-id="ff32d-620">Dönüş Değeri</span><span class="sxs-lookup"><span data-stu-id="ff32d-620">Return Value</span></span>

- <span data-ttu-id="ff32d-621">**UX_SUCCESS** (0x00) Bu işlem başarılı oldu.</span><span class="sxs-lookup"><span data-stu-id="ff32d-621">**UX_SUCCESS** (0x00) This operation was successful.</span></span>
- <span data-ttu-id="ff32d-622">**UX_CONFIGURATION_HANDLE_UNKNOWN** (0x51) arabirim çalışmıyor.</span><span class="sxs-lookup"><span data-stu-id="ff32d-622">**UX_CONFIGURATION_HANDLE_UNKNOWN** (0x51) The interface is down.</span></span>
- <span data-ttu-id="ff32d-623">**UX_BUFFER_OVERFLOW** (0x5D) FIFO arabelleği fssull şeklindedir.</span><span class="sxs-lookup"><span data-stu-id="ff32d-623">**UX_BUFFER_OVERFLOW** (0x5d) FIFO buffer is fssull.</span></span>
- <span data-ttu-id="ff32d-624">İşlevden **UX_ERROR** (0xFF) hatası</span><span class="sxs-lookup"><span data-stu-id="ff32d-624">**UX_ERROR** (0xFF) Error from function</span></span>

### <a name="example"></a><span data-ttu-id="ff32d-625">Örnek</span><span class="sxs-lookup"><span data-stu-id="ff32d-625">Example</span></span>
...
## <a name="ux_device_class_audio10_control_process"></a><span data-ttu-id="ff32d-626">ux_device_class_audio10_control_process</span><span class="sxs-lookup"><span data-stu-id="ff32d-626">ux_device_class_audio10_control_process</span></span>

<span data-ttu-id="ff32d-627">USB ses 1,0 denetim isteklerini işle</span><span class="sxs-lookup"><span data-stu-id="ff32d-627">Process USB Audio 1.0 control requests</span></span>

### <a name="prototype"></a><span data-ttu-id="ff32d-628">Prototype</span><span class="sxs-lookup"><span data-stu-id="ff32d-628">Prototype</span></span>
...
### <a name="description"></a><span data-ttu-id="ff32d-629">Açıklama</span><span class="sxs-lookup"><span data-stu-id="ff32d-629">Description</span></span>

<span data-ttu-id="ff32d-630">Bu işlev, denetim uç noktasındaki ana bilgisayar tarafından gönderilen temel istekleri, USB ses 1,0 'e özgü bir türle yönetir.</span><span class="sxs-lookup"><span data-stu-id="ff32d-630">This function manages basic requests sent by the host on the control endpoint with a USB Audio 1.0 specific type.</span></span>

<span data-ttu-id="ff32d-631">Birim ve sessiz isteklerin ses 1,0 özellikleri işlevinde işlenir.</span><span class="sxs-lookup"><span data-stu-id="ff32d-631">Audio 1.0 features of volume and mute requests are processed in the function.</span></span> <span data-ttu-id="ff32d-632">İstekleri işlerken, istekleri yanıtlamak ve denetim değişikliklerini depolamak için son parametre (Grup) tarafından geçirilen önceden tanımlanmış veriler kullanılır.</span><span class="sxs-lookup"><span data-stu-id="ff32d-632">When processing the requests, pre-defined data passed by the last parameter (group) is used to answer requests and store control changes.</span></span>

### <a name="parameters"></a><span data-ttu-id="ff32d-633">Parametreler</span><span class="sxs-lookup"><span data-stu-id="ff32d-633">Parameters</span></span>

- <span data-ttu-id="ff32d-634">**Ses**: ses örneğine yönelik işaretçi.</span><span class="sxs-lookup"><span data-stu-id="ff32d-634">**audio**: Pointer to the audio instance.</span></span>
- <span data-ttu-id="ff32d-635">**Transfer**: aktarım isteği örneğine yönelik işaretçi.</span><span class="sxs-lookup"><span data-stu-id="ff32d-635">**transfer**: Pointer to the transfer request instance.</span></span>
- <span data-ttu-id="ff32d-636">**Grup**: istek işlemi için veri grubu.</span><span class="sxs-lookup"><span data-stu-id="ff32d-636">**group**: Data group for request process.</span></span>

### <a name="return-value"></a><span data-ttu-id="ff32d-637">Dönüş Değeri</span><span class="sxs-lookup"><span data-stu-id="ff32d-637">Return Value</span></span>

- <span data-ttu-id="ff32d-638">**UX_SUCCESS** (0x00) Bu işlem başarılı oldu.</span><span class="sxs-lookup"><span data-stu-id="ff32d-638">**UX_SUCCESS** (0x00) This operation was successful.</span></span>
- <span data-ttu-id="ff32d-639">İşlevden **UX_ERROR** (0xFF) hatası</span><span class="sxs-lookup"><span data-stu-id="ff32d-639">**UX_ERROR** (0xFF) Error from function</span></span>

### <a name="example"></a><span data-ttu-id="ff32d-640">Örnek</span><span class="sxs-lookup"><span data-stu-id="ff32d-640">Example</span></span>
...
## <a name="ux_device_class_audio20_control_process"></a><span data-ttu-id="ff32d-641">ux_device_class_audio20_control_process</span><span class="sxs-lookup"><span data-stu-id="ff32d-641">ux_device_class_audio20_control_process</span></span>

<span data-ttu-id="ff32d-642">USB ses 1,0 denetim isteklerini işle</span><span class="sxs-lookup"><span data-stu-id="ff32d-642">Process USB Audio 1.0 control requests</span></span>

### <a name="prototype"></a><span data-ttu-id="ff32d-643">Prototype</span><span class="sxs-lookup"><span data-stu-id="ff32d-643">Prototype</span></span>
```C
...
### <a name="description"></a><span data-ttu-id="ff32d-644">Açıklama</span><span class="sxs-lookup"><span data-stu-id="ff32d-644">Description</span></span>

<span data-ttu-id="ff32d-645">Bu işlev, denetim uç noktasındaki ana bilgisayar tarafından gönderilen temel istekleri, USB ses 2,0 'e özgü bir türle yönetir.</span><span class="sxs-lookup"><span data-stu-id="ff32d-645">This function manages basic requests sent by the host on the control endpoint with a USB Audio 2.0 specific type.</span></span>

<span data-ttu-id="ff32d-646">Ses 2,0 örnekleme hızı (tek sabit sıklık varsayıldı), birim ve sessiz isteklerin özellikleri işlevinde işlenir.</span><span class="sxs-lookup"><span data-stu-id="ff32d-646">Audio 2.0 sampling rate (assumed single fixed frequency), features of volume and mute requests are processed in the function.</span></span> <span data-ttu-id="ff32d-647">İstekleri işlerken, istekleri yanıtlamak ve denetim değişikliklerini depolamak için son parametre (Grup) tarafından geçirilen önceden tanımlanmış veriler kullanılır.</span><span class="sxs-lookup"><span data-stu-id="ff32d-647">When processing the requests, pre-defined data passed by the last parameter (group) is used to answer requests and store control changes.</span></span>

### <a name="parameters"></a><span data-ttu-id="ff32d-648">Parametreler</span><span class="sxs-lookup"><span data-stu-id="ff32d-648">Parameters</span></span>

- <span data-ttu-id="ff32d-649">**Ses**: ses örneğine yönelik işaretçi.</span><span class="sxs-lookup"><span data-stu-id="ff32d-649">**audio**: Pointer to the audio instance.</span></span>
- <span data-ttu-id="ff32d-650">**Transfer**: aktarım isteği örneğine yönelik işaretçi.</span><span class="sxs-lookup"><span data-stu-id="ff32d-650">**transfer**: Pointer to the transfer request instance.</span></span>
- <span data-ttu-id="ff32d-651">**Grup**: istek işlemi için veri grubu.</span><span class="sxs-lookup"><span data-stu-id="ff32d-651">**group**: Data group for request process.</span></span>

### <a name="return-value"></a><span data-ttu-id="ff32d-652">Dönüş Değeri</span><span class="sxs-lookup"><span data-stu-id="ff32d-652">Return Value</span></span>

- <span data-ttu-id="ff32d-653">**UX_SUCCESS** (0x00) Bu işlem başarılı oldu.</span><span class="sxs-lookup"><span data-stu-id="ff32d-653">**UX_SUCCESS** (0x00) This operation was successful.</span></span>
- <span data-ttu-id="ff32d-654">İşlevden **UX_ERROR** (0xFF) hatası</span><span class="sxs-lookup"><span data-stu-id="ff32d-654">**UX_ERROR** (0xFF) Error from function</span></span>

### <a name="example"></a><span data-ttu-id="ff32d-655">Örnek</span><span class="sxs-lookup"><span data-stu-id="ff32d-655">Example</span></span>
