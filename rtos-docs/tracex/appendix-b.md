...
---
# <a name="appendix-b---the-tx_traceh-file"></a><span data-ttu-id="d7a1d-103">Ek B-tx_trace. h dosyası</span><span class="sxs-lookup"><span data-stu-id="d7a1d-103">Appendix B - The tx_trace.h file</span></span>

<span data-ttu-id="d7a1d-104">Bu bölümde **tx_trace. h** dosyası görüntülenir.</span><span class="sxs-lookup"><span data-stu-id="d7a1d-104">This chapter displays the **tx_trace.h** file.</span></span>
