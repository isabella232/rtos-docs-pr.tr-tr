...
---
# <a name="appendix-a---sample-tx_porth"></a><span data-ttu-id="297b3-103">Ek A-örnek tx_port. h</span><span class="sxs-lookup"><span data-stu-id="297b3-103">Appendix A - Sample tx_port.h</span></span>

<span data-ttu-id="297b3-104">Bu bölümde bir örnek **tx_port. h** dosyası görüntülenir.</span><span class="sxs-lookup"><span data-stu-id="297b3-104">This chapter displays a sample **tx_port.h** file.</span></span>
