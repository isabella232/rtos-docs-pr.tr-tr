---
title: Ek A-Azure RTOS NetX Duo Hizmetleri
description: Azure RTOS NetX Duo hizmetleri hakkında bilgi edinin.
author: philmea
ms.author: philmea
ms.date: 05/19/2020
ms.topic: article
...
---
# <a name="appendix-a---azure-rtos-netx-duo-services"></a><span data-ttu-id="e4d66-103">Ek A-Azure RTOS NetX Duo Hizmetleri</span><span class="sxs-lookup"><span data-stu-id="e4d66-103">Appendix A - Azure RTOS NetX Duo Services</span></span>

## <a name="address-resolution-protocol-arp"></a><span data-ttu-id="e4d66-104">Adres Çözümleme Protokolü (ARP)</span><span class="sxs-lookup"><span data-stu-id="e4d66-104">Address Resolution Protocol (ARP)</span></span>  
...
## <a name="internet-control-message-protocol-icmp"></a><span data-ttu-id="e4d66-105">Internet Denetim Iletisi Protokolü (ıCMP)</span><span class="sxs-lookup"><span data-stu-id="e4d66-105">Internet Control Message Protocol (ICMP)</span></span>  
...
## <a name="internet-group-management-protocol-igmp"></a><span data-ttu-id="e4d66-106">Internet Grup Yönetimi Protokolü (IGMP)</span><span class="sxs-lookup"><span data-stu-id="e4d66-106">Internet Group Management Protocol (IGMP)</span></span>  
...
UINT     nx_igmp_multicast_leave(NX_IP *ip_ptr,
            ULONG group_address);
```
## <a name="internet-protocol-ip"></a><span data-ttu-id="e4d66-107">Internet Protokolü (IP)</span><span class="sxs-lookup"><span data-stu-id="e4d66-107">Internet Protocol (IP)</span></span> 
...
## <a name="neighbor-discovery"></a><span data-ttu-id="e4d66-108">Komşu bulma</span><span class="sxs-lookup"><span data-stu-id="e4d66-108">Neighbor Discovery</span></span>  
...
## <a name="packet-management"></a><span data-ttu-id="e4d66-109">Paket Yönetimi</span><span class="sxs-lookup"><span data-stu-id="e4d66-109">Packet Management</span></span>  
...
## <a name="reverse-address-resolution-protocol-rarp"></a><span data-ttu-id="e4d66-110">Ters Adres Çözümleme Protokolü (RARP)</span><span class="sxs-lookup"><span data-stu-id="e4d66-110">Reverse Address Resolution Protocol (RARP)</span></span>  
...
## <a name="system-management"></a><span data-ttu-id="e4d66-111">Sistem Yönetimi</span><span class="sxs-lookup"><span data-stu-id="e4d66-111">System Management</span></span>  

```c
VOID     nx_system_initialize(VOID);
```

## <a name="transmission-control-protocol-tcp"></a><span data-ttu-id="e4d66-112">İletim Denetimi Protokolü (TCP)</span><span class="sxs-lookup"><span data-stu-id="e4d66-112">Transmission Control Protocol (TCP)</span></span>  
...
## <a name="user-datagram-protocol-udp"></a><span data-ttu-id="e4d66-113">Kullanıcı veri birimi Protokolü (UDP)</span><span class="sxs-lookup"><span data-stu-id="e4d66-113">User Datagram Protocol (UDP)</span></span>  
