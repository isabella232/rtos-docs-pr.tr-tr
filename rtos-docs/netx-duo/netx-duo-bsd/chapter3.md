---
title: Bölüm 3-Azure RTOS NetX Duo BSD Hizmetleri
description: Bu bölüm, tüm Azure RTOS NetX Duo BSD temel hizmetlerinin (aşağıda listelenmiştir) alfabetik sırada bir açıklamasını içerir.
author: philmea
ms.author: philmea
ms.date: 06/04/2020
ms.topic: article
...
ms.locfileid: "104826152"
---
# <a name="chapter-3---azure-rtos-netx-duo-bsd-services"></a><span data-ttu-id="dbaa1-103">Bölüm 3-Azure RTOS NetX Duo BSD Hizmetleri</span><span class="sxs-lookup"><span data-stu-id="dbaa1-103">Chapter 3 - Azure RTOS NetX Duo BSD Services</span></span>

<span data-ttu-id="dbaa1-104">Bu bölüm, tüm Azure RTOS NetX Duo BSD temel hizmetlerinin (aşağıda listelenmiştir) alfabetik sırada bir açıklamasını içerir.</span><span class="sxs-lookup"><span data-stu-id="dbaa1-104">This chapter contains a description of all Azure RTOS NetX Duo BSD basic services (listed below) in alphabetic order.</span></span>
