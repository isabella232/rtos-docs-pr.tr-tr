...
---
# <a name="chapter-3---azure-rtos-netx-duo-bsd-services"></a>Bölüm 3-Azure RTOS NetX Duo BSD Hizmetleri

Bu bölüm, tüm Azure RTOS NetX Duo BSD temel hizmetlerinin (aşağıda listelenmiştir) alfabetik sırada bir açıklamasını içerir.
