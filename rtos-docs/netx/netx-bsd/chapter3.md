...
---
# <a name="chapter-3---azure-rtos-netx-bsd-services"></a>Bölüm 3-Azure RTOS NetX BSD Hizmetleri

Bu bölümde, aşağıda listelenen tüm Azure RTOS NetX BSD temel hizmetlerinin alfabetik sırada bir açıklaması yer almaktadır.
