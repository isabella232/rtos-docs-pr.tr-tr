...
ms.locfileid: "104825648"
---
# <a name="appendix-a---azure-rtos-netx-services"></a><span data-ttu-id="e5a42-103">Ek A-Azure RTOS NetX Hizmetleri</span><span class="sxs-lookup"><span data-stu-id="e5a42-103">Appendix A - Azure RTOS NetX Services</span></span>

## <a name="address-resolution-protocol-arp"></a><span data-ttu-id="e5a42-104">Adres Çözümleme Protokolü (ARP)</span><span class="sxs-lookup"><span data-stu-id="e5a42-104">Address Resolution Protocol (ARP)</span></span>  
...
## <a name="internet-control-message-protocol-icmp"></a><span data-ttu-id="e5a42-105">Internet Denetim Iletisi Protokolü (ıCMP)</span><span class="sxs-lookup"><span data-stu-id="e5a42-105">Internet Control Message Protocol (ICMP)</span></span>  
...
## <a name="internet-group-management-protocol-igmp"></a><span data-ttu-id="e5a42-106">Internet Grup Yönetimi Protokolü (IGMP)</span><span class="sxs-lookup"><span data-stu-id="e5a42-106">Internet Group Management Protocol (IGMP)</span></span>  
...
## <a name="internet-protocol-ip"></a><span data-ttu-id="e5a42-107">Internet Protokolü (IP)</span><span class="sxs-lookup"><span data-stu-id="e5a42-107">Internet Protocol (IP)</span></span>  
...
## <a name="packet-management"></a><span data-ttu-id="e5a42-108">Paket Yönetimi</span><span class="sxs-lookup"><span data-stu-id="e5a42-108">Packet Management</span></span>  
...
## <a name="reverse-address-resolution-protocol-rarp"></a><span data-ttu-id="e5a42-109">Ters Adres Çözümleme Protokolü (RARP)</span><span class="sxs-lookup"><span data-stu-id="e5a42-109">Reverse Address Resolution Protocol (RARP)</span></span>  
...
## <a name="system-management"></a><span data-ttu-id="e5a42-110">Sistem Yönetimi</span><span class="sxs-lookup"><span data-stu-id="e5a42-110">System Management</span></span>  

```c
VOID nx_system_initialize(VOID);
```

## <a name="transmission-control-protocol-tcp"></a><span data-ttu-id="e5a42-111">İletim Denetimi Protokolü (TCP)</span><span class="sxs-lookup"><span data-stu-id="e5a42-111">Transmission Control Protocol (TCP)</span></span>  
...
## <a name="user-datagram-protocol-udp"></a><span data-ttu-id="e5a42-112">Kullanıcı veri birimi Protokolü (UDP)</span><span class="sxs-lookup"><span data-stu-id="e5a42-112">User Datagram Protocol (UDP)</span></span>  
